# SINEAPP - Free Movies & TV Shows Streaming

<div style="text-align:center">

![SINEAPP Mockup Screenshot](https://raw.githubusercontent.com/mikolsvonez438/sineapp/refs/heads/main/src/public/img/mockup.png)

</div>

SINEAPP is an open-source, free movies and TV shows streaming platform built with the latest web technologies. It offers a seamless and enjoyable viewing experience, allowing users to discover, search, and enjoy a vast library of content.

## Key Features

- **💸 Free and Open-Source**: SINEAPP is completely free to use and the source code is available for anyone to explore, contribute, and build upon.
...
SINEAPP is built using the following technologies:
...
- **The Movie Database (TMDB) API**: SINEAPP integrates with the TMDB API to retrieve movie and TV show data, ensuring access to a vast and up-to-date content library.
- **Supabase**: The project uses Supabase for user authentication and database management.

## Getting Started

To run SINEAPP locally, follow these steps:

1. Clone the repository:

```
git clone https://github.com/mikolsvonez438/sineapp.git
```
...
4. Open your browser and visit `http://localhost:3000` to access the SINEAPP application.

## Contributing

Contributions to SINEAPP are welcome! If you'd like to contribute, please refer to the [CONTRIBUTING](CONTRIBUTING.md) file for guidelines and instructions.

## License

SINEAPP is licensed under the [MIT License](LICENSE). This means you are free to use, modify, and distribute the application, as long as you include the original copyright and license notice in your work.

## Star History

<a href="https://www.star-history.com/#mikolsvonez438/sineapp&Timeline">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mikolsvonez438/sineapp&type=Timeline&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=mikolsvonez438/sineapp&type=Timeline" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=mikolsvonez438/sineapp&type=Timeline" />
 </picture>
</a>
